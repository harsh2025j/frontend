...
export default function HighCourt() {
    useDocTitle("High Court | Sajjad Husain Law Associates");
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            <div className="relative bg-gradient-to-r from-[#122340] via-[#1A73E8] to-[#122340] text-white py-20 lg:py-32 px-4 overflow-hidden">
                ...
                <div className="container mx-auto max-w-6xl relative z-10">
                    <div className="flex flex-col items-center justify-center gap-6 mb-6">
                        ...
                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-center">High Court</h1>
                    </div>
                    <p className="text-xl md:text-2xl text-center text-blue-100 max-w-3xl mx-auto">
                        Latest Updates from High Courts Across India
                    </p>
                </div>
            </div>
            <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16">
                <div className="bg-white rounded-2xl shadow-xl p-10 border border-blue-100">
                    <h2 className="text-3xl font-bold text-[#122340] mb-6">High Court Coverage</h2>
                    <p className="text-gray-700 leading-relaxed">
                        Comprehensive coverage of High Court proceedings, judgments, and legal developments from courts across India. Stay informed about important cases and judicial pronouncements.
                    </p>
                </div>
            </div>

        ...
        <div className="min-h-screen bg-slate-50 font-sans print:bg-white pb-20">
            ...
            <style dangerouslySetInnerHTML={{ __html: `
                @media print {
                    ...
                    /* Force background colors for specific branding elements */
                    .bg-\\[\\#0A2342\\] { 
            ...
            <div className="no-print bg-white/95 backdrop-blur-md border-b border-gray-200 sticky top-0 z-30 px-6 py-4 shadow-sm">
                <div className="max-w-5xl mx-auto flex justify-between items-center">
                    {!isModal ? (
                        <button
                            onClick={() => router.back()}
                            className="flex items-center gap-2 text-gray-500 hover:text-[#0A2342] font-bold text-sm transition-colors"
                        >
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            onClick={handlePrint}
                            className="flex items-center gap-2 px-6 py-2.5 bg-[#0A2342] text-white rounded-xl hover:bg-[#153a66] transition-all shadow-lg shadow-blue-900/20 text-sm font-bold"
                        >
            ...
            <div className={`${isModal ? "w-full" : "max-w-5xl mx-auto"} px-4 sm:px-6 md:px-10 py-6 md:py-10 print:p-0 print:max-w-none print:w-full`}>
                ...
                <div className="document-container bg-white shadow-2xl shadow-slate-200 border border-gray-100 rounded-[1.5rem] md:rounded-[2rem] overflow-hidden print:rounded-none">
                    ...
                    <div className="bg-[#0A2342] p-10 text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                            <div className="flex-1">
                                ...
                                <h1 className="text-2xl md:text-3xl font-serif font-black leading-tight mb-2">
                                    {caseData.court || "In the Honorable Court"}
                                </h1>
                                <p className="text-amber-400 font-serif italic text-lg opacity-90">
                                    {caseData.title || "Subject Pending Registration"}
                                </p>
                            </div>
                            <div className="flex flex-col items-end gap-2 shrink-0">
                                <div className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border border-white/20 bg-white/10 ${
                                    caseData.status === "closed" ? "text-red-300" : "text-green-300"
                                }`}>
                    ...
                    <div className="p-10 md:p-14">
                        {/* Section 1: Fundamental Identifiers */}
                        ...
                        {/* Section 3: Litigant & Counsel Table */}
                        ...
                        {/* Section 5: Current Prosecution Timeline */}
                        ...
                        {/* Section 6: Criminal Context (Conditional) */}
                        {caseData.firNumber && (
                        ...
                        {/* Section 7: Judgment & Disposal (Conditional) */}

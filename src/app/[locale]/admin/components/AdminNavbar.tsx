...
const AdminNavbar = ({ onToggleSidebar }: NavbarProps) => {
  ...
  return (
    <>
      <header className="w-full h-16 bg-white text-gray-800 flex items-center justify-between px-4 fixed top-0 left-0 z-[500] shadow-sm border-b border-gray-200 transition-colors duration-300">
        ...
        <div className="flex items-center gap-4 w-full max-w-xl">
          ...
          {/* 
          <div className="hidden md:flex items-center gap-2 w-full max-w-md bg-gray-100 rounded-lg px-4 py-2 transition-colors duration-300">
            <Search className="text-gray-500" size={18} />
            <input
              type="text"
              placeholder="Search cases, clients..."
              className="w-full bg-transparent focus:outline-none text-sm text-gray-900 placeholder-gray-500"
            />
          </div> */}
          {/* test */}
        </div>

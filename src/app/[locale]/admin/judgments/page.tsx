...
function JudgmentsTableSkeleton() {
    return (
        <>
            {[...Array(6)].map((_, i) => (
...
function AdminJudgmentsSkeleton() {
    return (
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                {[...Array(5)].map((_, i) => (
                                    <th key={i} className="px-6 py-3 text-left"><div className="h-4 w-24 bg-gray-300 rounded"></div></th>
                                ))}
                            </tr>
                        </thead>
                        <tbody className="bg-white divide-y divide-gray-200">
...
export default function AdminJudgmentsPage() {
    return (
        <React.Suspense fallback={<AdminJudgmentsSkeleton />}>

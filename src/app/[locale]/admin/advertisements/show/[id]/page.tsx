...
export default function ShowAdvertisementPage() {
  ...
  if (loading && !ad) return <ShowAdvertisementSkeleton />;
...
function ShowAdvertisementSkeleton() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 pb-20 space-y-6 animate-pulse">
      {/* Header */}
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 bg-white px-5 py-4 rounded-xl border border-gray-200">
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              ...
              <div className="w-12 h-5 bg-gray-100 rounded-md"></div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <section className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
          ...
          <div className="h-40 w-full bg-gray-50 rounded-lg border border-gray-100"></div>
        </section>
        ...
        <section className="bg-white border border-gray-200 rounded-xl p-6 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="w-full h-20 bg-gray-50 rounded-lg border border-gray-100"></div>
          </div>
        </section>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="bg-white border border-gray-200 rounded-xl p-4">
              ...
              <div className="flex gap-3 mb-3">
                <div className="w-11 h-11 bg-gray-100 rounded-lg shrink-0"></div>

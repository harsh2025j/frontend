...
const AdminNavbar = ({ onToggleSidebar }: NavbarProps) => {
  ...
  return (
    <>
      <header className="w-full h-16 bg-white text-gray-800 flex items-center justify-between px-4 fixed top-0 left-0 z-40 shadow-sm border-b border-gray-200 transition-colors duration-300">

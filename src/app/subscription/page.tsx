...
export default function subscription() {
  ...
  return (
    <div className="min-h-screen bg-[#f3f3f3] flex flex-col items-center py-16 font-sans">
      ...
      <div className="bg-[#e9edf3] rounded-full flex w-40 justify-between mb-14">
        <button className="w-1/2 py-2 text-sm font-semibold bg-[#122340] text-white rounded-full">
          MONTHLY
        </button>
        <button className="w-1/2 py-2 text-sm font-semibold text-[#122340]">
          YEARLY
        </button>
      </div>
      ...
      <div className="bg-white  p-5 rounded-2xl container">
        <div className="flex justify-between gap-10 px-8 items-start relative">
          ...
          <div className="bg-white rounded-2xl w-[300px] px-8 py-10 flex flex-col border border-transparent hover:border-2 hover:border-blue-300 transition-all duration-300">
            ...
            <button className="border border-[#122340] text-[#122340] font-semibold rounded-full py-2 px-6 mt-auto">
              Choose Plan
            </button>
          </div>
          ...
          <div className="relative bg-gradient-to-b from-[#9747FF] to-[#1959A8] text-white rounded-2xl w-[320px] px-8 py-12 flex flex-col items-start scale-105 shadow-lg -mt-10 z-10 border border-transparent  hover:border-blue-300 transition-all duration-300">
            ...
            <p className="text-sm mb-4 text-white/90">
              ₹499 <span className="text-xs block">/month<br />billed monthly</span>
            </p>
            ...
            <button className="bg-white text-[#2D0FD4] font-semibold rounded-full py-2 px-6 mt-auto">
              Choose Plan
            </button>
          </div>
          ...
          <div className="bg-white rounded-2xl w-[300px] px-8 py-10 flex flex-col border border-transparent hover:border-2 hover:border-blue-300 transition-all duration-300">
            ...
            <p className="text-sm text-gray-500 mb-4">
              ₹199 <span className="text-xs text-gray-400">/month<br />billed monthly</span>
            </p>

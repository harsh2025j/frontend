 ...
 */
export default function CaseLinkedBadge({ caseId, caseSlug, caseTitle, caseNumber }: CaseLinkedBadgeProps) {
  if (!caseId && !caseSlug) return null;

  const displayText = caseNumber || caseTitle || "Linked Case";

  return (
    <Link
      href={`/cases/${caseSlug || caseId}`}
